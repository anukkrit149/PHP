...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 16, 2018 at 01:41 AM
...
CREATE TABLE `threads` (
  ...
  `thread_by` varchar(50) NOT NULL,
  `thread_cat` varchar(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(1, 'anukkrit', '1234', 'bsbabj@jbdjka.com', '0000-00-00 00:00:00', 0),
(3, 'anukkrit12', '1234', 'anukkrit.official@gmail.com', '2018-12-11 00:00:00', 0);
...
ALTER TABLE `threads`
  ...
  ADD UNIQUE KEY `threads_thread_name_uindex` (`thread_name`);
