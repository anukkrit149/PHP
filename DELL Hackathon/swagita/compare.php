                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="product-image-title">
                                                    ...
                                                    <a href="product-details.php" class="title">Perfect Diamond Jewelry</a>
                                                </td>
                                                <td class="product-image-title">
                                                    <a href="product-details.php" class="image">
                                                    ...
                                                    <a href="product-details.php" class="title">Handmade Golden Necklace</a>
                                                </td>
                                                <td class="product-image-title">
                                                    <a href="product-details.php" class="image">
                                                    ...
                                                    <a href="product-details.php" class="title">Diamond Exclusive Ornament</a>
                                                </td>
                                            </tr>
                                            <tr>
